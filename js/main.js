...
var X00Gems = ['<img src="img/gems-icon.png" alt="" class="cr-gem-icon" /> 1000 Gems', '<img src="img/gems-icon.png" alt="" class="cr-gem-icon" /> 99999 Gems', '<img src="img/gems-icon.png" alt="" class="cr-gem-icon" /> 99999 Gems', '<img src="img/gold-icon.png" alt="" class="cr-gem-icon" /> 50000 Gold', '<img src="img/gold-icon.png" alt="" class="cr-gem-icon" /> 99999 Gold', '<img src="img/gold-icon.png" alt="" class="cr-gem-icon" /> 1000 Gold', '<img src="img/m-chest.png" alt="" class="cr-gem-icon" /> 1 Super Magical Chest', '<img src="img/m-chest.png" alt="" class="cr-gem-icon" /> 4 Super Magical Chest', '<img src="img/m-chest.png" alt="" class="cr-gem-icon" /> 2 Super Magical Chest'];
